                    ...
                    >
                        ...
                        >
                           <button
                                onClick={() => setSelectedCert(null)}
                                aria-label="Tutup"
                                className={`absolute -top-[10px] -right-[1px] sm:-top-[20px] sm:-right-[20px] z-20 size-9 sm:size-10 rounded-full flex items-center justify-center p-0 transition-colors cursor-pointer shadow-lg border ${
                                    darkMode
